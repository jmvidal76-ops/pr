namespace ReglasMES
{
    ...
    /// <summary>
    /// Perform calls to Instance Rule MSM.OEE-MANAGER.MSM-UC-ENV-PROD_EXE-19-JUSTIFICAR_PERDIDA.ROOT_JUSTIFICA_PERDIDA
    /// </summary>
    /// 
    public class JustificarPerdidas : G2Base.PMCall
    {
        
        protected static string m_EquipmentPath = "OEE-MANAGER";
        
        protected static string m_Path = "OEE-MANAGER.MSM-UC-ENV-PROD_EXE-19-JUSTIFICAR_PERDIDA.ROOT_JUSTIFICA_PERDIDA";
        
        /// <summary>
        /// Create an object to invoke "MSM.OEE-MANAGER.MSM-UC-ENV-PROD_EXE-19-JUSTIFICAR_PERDIDA.ROOT_JUSTIFICA_PERDIDA" on the equipment "MSM.OEE-MANAGER"
        /// </summary>
        /// <param name="connector">The PMConnector to perform calls to Production Modeler</param>
        public JustificarPerdidas(G2Base.PMConnector connector) : 
                base(connector, "MSM.OEE-MANAGER", "MSM.OEE-MANAGER.MSM-UC-ENV-PROD_EXE-19-JUSTIFICAR_PERDIDA.ROOT_JUSTIFICA_PERDIDA", 13, 3)
        {
            InitParamNames();
        }
        ...
        public JustificarPerdidas(G2Base.PMConnector connector, string equipment, string ruleName) : 
        ...
        public JustificarPerdidas(G2Base.PMConnector connector, string plant) : 
