namespace ReglasMES
{
    ...
    /// <summary>
    /// Perform calls to Instance Rule MSM.WO-MANAGER.CONSOLIDACION_DATOS.RECALCULAR_MEDIAS_CAMBIOS
    /// </summary>
    public class RecalcularMediasCambios : G2Base.PMCall
    {
        
        protected static string m_EquipmentPath = "WO-MANAGER";
        
        protected static string m_Path = "WO-MANAGER.CONSOLIDACION_DATOS.RECALCULAR_MEDIAS_CAMBIOS";
        
        /// <summary>
        /// Create an object to invoke "MSM.WO-MANAGER.CONSOLIDACION_DATOS.RECALCULAR_MEDIAS_CAMBIOS" on the equipment "MSM.WO-MANAGER"
        /// </summary>
        /// <param name="connector">The PMConnector to perform calls to Production Modeler</param>
        public RecalcularMediasCambios(G2Base.PMConnector connector) : 
                base(connector, "MSM.WO-MANAGER", "MSM.WO-MANAGER.CONSOLIDACION_DATOS.RECALCULAR_MEDIAS_CAMBIOS", 2, 0)
        {
            InitParamNames();
        }
        ...
        public RecalcularMediasCambios(G2Base.PMConnector connector, string equipment, string ruleName) : 
        ...
        public RecalcularMediasCambios(G2Base.PMConnector connector, string plant) : 
