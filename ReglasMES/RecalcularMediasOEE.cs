namespace ReglasMES
{
    ...
    /// <summary>
    /// Perform calls to Instance Rule MSM.WO-MANAGER.CONSOLIDACION_DATOS.RECALCULAR_MEDIAS_OEE
    /// </summary>
    public class RecalcularMediasOEE : G2Base.PMCall
    {
        
        protected static string m_EquipmentPath = "WO-MANAGER";
        
        protected static string m_Path = "WO-MANAGER.CONSOLIDACION_DATOS.RECALCULAR_MEDIAS_OEE";
        
        /// <summary>
        /// Create an object to invoke "MSM.WO-MANAGER.CONSOLIDACION_DATOS.RECALCULAR_MEDIAS_OEE" on the equipment "MSM.WO-MANAGER"
        /// </summary>
        /// <param name="connector">The PMConnector to perform calls to Production Modeler</param>
        public RecalcularMediasOEE(G2Base.PMConnector connector) : 
                base(connector, "MSM.WO-MANAGER", "MSM.WO-MANAGER.CONSOLIDACION_DATOS.RECALCULAR_MEDIAS_OEE", 2, 0)
        {
            InitParamNames();
        }
        ...
        public RecalcularMediasOEE(G2Base.PMConnector connector, string equipment, string ruleName) : 
        ...
        public RecalcularMediasOEE(G2Base.PMConnector connector, string plant) : 
