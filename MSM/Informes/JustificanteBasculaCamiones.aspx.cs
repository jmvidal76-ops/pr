...
{
    public partial class JustificanteBasculaCamiones : System.Web.UI.Page
    {
        protected async void Page_Load(object sender, EventArgs e)
        {
            if (!Page.IsPostBack)
            {
                try
                {
                    ...
                    string path = parametrosAlbaran.Find(f => f.EnumParametro.Equals(ParametrosAlbaranEnum.RutaJustificante.ToString(), StringComparison.CurrentCultureIgnoreCase)).Parametro;
