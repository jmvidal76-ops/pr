...
{
    public partial class INF_ENV_PROD_ANA_2 : System.Web.UI.Page
    {
        ...
        protected void printBTN_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                FileStream fs = new FileStream(Server.MapPath("Report2.PDF"), FileMode.OpenOrCreate);

                fs.Write(bytes, 0, bytes.Length);
                fs.Close();

                Response.ContentType = "Application/pdf";
                Response.TransmitFile(Server.MapPath("Report2.PDF"));
            }
            catch (Exception ex)
            {
            }
