...
{
    public partial class INF_ENV_PROD_ANA_7 : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!Page.IsPostBack)
            {
                ...
                //listaParametros.Add(new ReportParameter("Causa", Request["Causa"], false));
                listaParametros.Add(new ReportParameter("Motivo", Request["Motivo"], false));
        ...
        protected void printBTN_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                FileStream fs = new FileStream(Server.MapPath("Report7.PDF"), FileMode.OpenOrCreate);

                fs.Write(bytes, 0, bytes.Length);
                fs.Close();

                Response.ContentType = "Application/pdf";
                Response.TransmitFile(Server.MapPath("Report7.PDF"));
            }
            catch (Exception ex)
            {
            }
