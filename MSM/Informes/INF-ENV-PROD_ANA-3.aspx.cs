...
{
    public partial class INF_ENV_PROD_ANA_3 : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!Page.IsPostBack)
            {
                ...
                listaParametros.Add(new ReportParameter("Maquina", Request["Maquina"], false));
        ...
        protected void printBTN_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                FileStream fs = new FileStream(Server.MapPath("Report3.PDF"), FileMode.OpenOrCreate);

                fs.Write(bytes, 0, bytes.Length);
                fs.Close();

                Response.ContentType = "Application/pdf";
                Response.TransmitFile(Server.MapPath("Report3.PDF"));
            }
            catch (Exception ex)
            {
            }
