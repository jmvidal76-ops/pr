define(['underscore', 'backbone', 'jquery', 'text!../../../Envasado/html/SintesisArranque.html', 'compartido/notificaciones',
        'vistas/vDialogoConfirm', 'jszip', 'compartido/util', 'vistas/Envasado/vEditarAccionMejora'],
    function (_, Backbone, $, PlantillaSintesisArranque, Not, VistaDlgConfirm, JSZip, util, VistaEditarAccionMejora) {
        var VistaSintesisArranque = Backbone.View.extend({
            tagName: 'div',
            id: 'divHTMLContenido',
            ...
            ds: null,
            vista: null,
            template: _.template(PlantillaSintesisArranque),
            initialize: function () {
                var self = this;
                window.JSZip = JSZip;
            ...
            render: function () {
                ...
                $("#gridSintesisTurnoArranque").hide();
                ...
                this.$("#gridAccionesMejora").kendoGrid({
                    ...
                    excel: {
                        fileName: window.app.idioma.t('EXCEL_SINTESIS_ARRANQUE') + ".xlsx",
                        filterable: true,
                        allPages: true,
                    },
                    sortable: true,
                    ...
                    columns: [
                        ...
                        },
                        {
                            ...
                            filterable: { // agomezn 270516: 040 Incluir un botón "Limpiar filtros" en las páginas donde se usen filtros
                                ui: function (element) {
                                    element.kendoDatePicker({
                                        format: kendo.culture().calendars.standard.patterns.MES_Fecha,
                                        culture: localStorage.getItem("idiomaSeleccionado")
                    ...
                    change: function (e) {
                        ...
                        for (var i = 0; i < selectedRows.length; i++) {
                            ...
                            var urlSplit = $("#gridSintesisTurnoArranque").data("kendoGrid").dataSource.transport.options.read.url.split('/');
                            urlSplit[3] = self.dataItemSel;
                            $("#gridSintesisTurnoArranque").data("kendoGrid").dataSource.transport.options.read.url = urlSplit.join('/');
                            $("#gridSintesisTurnoArranque").data("kendoGrid").dataSource.read();
                            $("#divFiltrosParosHeader").show();
                            $("#gridSintesisTurnoArranque").show();
                ...
                this.$("#gridSintesisTurnoArranque").kendoGrid({
                    dataSource: {
                        transport: {
                            read: {
                                url: "../api/accionesMejora/" + self.dataItemSel + "/Arranques",
                                dataType: "json",
            ...
            crearAccionMejora: function () {
                ...
                window.location.hash = "CrearAccionMejora/2";
            },
            editar: function (e) {
                var self = this;
                var permiso = TienePermiso(85);
            ...
            confirmarBorrado: function (e) {
                ...
                this.confirmacion = new VistaDlgConfirm({
                    ...
                    funcion: function () { self.borrarArranque(e); },
                    contexto: this
                });
            },
            borrarArranque: function (e) {
                var self = this;
                var tr = $(e.target.parentNode.parentNode).closest("tr");
            ...
            resizeGrid: function () {
                ...
                //Grid 1
                var gridElement = $("#gridSintesisTurnoArranque"),
            ...
            limpiarFiltroGridParos: function () {
                $("#gridSintesisTurnoArranque").data("kendoGrid").dataSource.filter({});
            },
