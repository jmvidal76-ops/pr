define(['underscore', 'backbone', 'jquery', 'text!../../../Envasado/html/DevolucionesMMPPEnvasado.html', 'compartido/notificaciones', 'compartido/util',
    'vistas/vDialogoConfirm', 'jszip', 'definiciones'],
    function (_, Backbone, $, plantillaDevolucionesMMPPEnvasado, Not, util, VistaDlgConfirm, JSZip, definiciones) {
        var gridDevolucionesMMPPEnvasado = Backbone.View.extend({
            tagName: 'div',
            id: 'divHTMLContenido',
            dsStock: null,
            dsUbiCons: null,
            ...
            prioridad: "",
            esInicio: true,
            template: _.template(plantillaDevolucionesMMPPEnvasado),
                        ...
                        transport: {
                            read: function (operation) {
                                ...
                                $.ajax({
                                    ...
                                    type: "GET",
                                    complete: function (e) {
                                        kendo.ui.progress($("#gridDevolucionesMMPPEnvasado"), false);
                                    },
            ...
            cargarGrid: function () {
                ...
                this.$("#gridDevolucionesMMPPEnvasado").kendoGrid({
            ...
            actualizarGrid: function () {
                ...
                kendo.ui.progress($("#gridDevolucionesMMPPEnvasado"), true);
                self.dsStock.read();                
            },
            ...
            confirmarDevoluciones: async function (e) {
                ...
                // Obtener el grid
                var grid = $("#gridDevolucionesMMPPEnvasado").data("kendoGrid");
                ...
                for (let item of dataSource) {
                    ...
                    if (sscc && sscc !== "") {
                        let solicitudes = await $.ajax({
                            url: "../api/solicitudes-mmpp/search?idSolicitud=0&SSCC=" + sscc + "&idLinea=&idMaterial=",
                            type: "GET"
                        });
            ...
            enviarDevoluciones: async function (datos, lotes) {
                return new Promise((resolve, reject) => {                   
                    ...
                    $.ajax({
                        type: "POST",
                        url: "../api/solicitudes-mmpp/devoluciones",
                        ...
                        error: function (e) {
                            if (e.status == '403' && e.responseJSON == 'NotAuthorized') {
                                ...
                                Not.crearNotificacion('error', window.app.idioma.t('ERROR'), 'solicitudes-mmpp/devoluciones', 4000);
                            }
                            reject("error");
                        }
                    });
            ...
            resizeGrid: function () {
                ...
                var gridElement = $("#gridDevolucionesMMPPEnvasado"),
