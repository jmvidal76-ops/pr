define(['underscore', 'backbone', 'jquery', 'text!../../../Envasado/html/SeleccionAccionMejora.html'],
    function (_, Backbone, $, SeleccionArranqueAccionMejora) {
        var VistaSeleccionArranqueAccionMejora = Backbone.View.extend({
            tagName: 'div',
            id: 'dlgSeleccionArranqueAccionMejora',
            checkedIds: [],
            checkedRows: [],
            dialog: null,
            linea: null,
            fechaTurno: null,
            idTipoTurno: null,
            template: _.template(SeleccionArranqueAccionMejora),
            ...
            render: function () {
                ...
                this.$("#gridSeleccion").kendoGrid({
                    dataSource: {
                        ...
                        transport: {
                            read: {
                                url: "../api/GetAccionesMejoraArranque/",
                                type: "POST",
                ...
                $(this.el).kendoWindow({
                    title: window.app.idioma.t('SELECCIÓN_DE_ARRANQUES'),
                    width: "90%",
                    height: "90%",
                    modal: true,
                    resizable: false,
                ...
                this.dialog = $('#dlgSeleccionArranqueAccionMejora').data("kendoWindow");
                this.dialog.center();
            },
            events: {           
            ...
            GuardarAccionMejora: function () {            
                Backbone.trigger('eventArranqueSeleccionados', this.checkedRows);
                this.dialog.close();
                this.eliminar();
            },
    ...
    return VistaSeleccionArranqueAccionMejora;
});