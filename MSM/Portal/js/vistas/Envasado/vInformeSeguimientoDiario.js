define(['underscore', 'backbone', 'jquery', 'text!../../../Envasado/html/InformeSeguimientoDiario.html', 'compartido/notificaciones'], function (_, Backbone, $, PlantillaInformeSeguimientoDiario,Not) {
    var VistaInformeSeguimientoDiario = Backbone.View.extend({
        tagName: 'div',
        template: _.template(PlantillaInformeSeguimientoDiario),
        ...
        render: function () {
            ...
            $(this.el).kendoWindow(
            {
                title: window.app.idioma.t('INFORME_SEGUIMIENTO_DIARIO'),
                width: "450",
                height: "360px",
                modal: true,
                resizable: false,
            ...
            function cambioSlider()
            {
                ...
                var slide1 = $("#rangeSlider").data("kendoRangeSlider").value()[0];
                var slide2 = $("#rangeSlider").data("kendoRangeSlider").value()[1];
        ...
        aceptar: function () {
            ...
            self.minOEE = this.$("#OEEMin").text();
            self.maxOEE = this.$("#OEEMax").text();
            ...
            if (self.linea == "" || self.turnoInicio == "Seleccione" || self.turnoFin == "Seleccione" || self.dpinicio == null || self.dpfin == null) {
                ...
                $.ajax({
                    ...
                    $.ajax({
                        ...
                        form.setAttribute("action", "/Informes/INF-ENV-PROD_ANA-6.aspx");
                        ...
                        var minOEEField = document.createElement("input");
                        minOEEField.setAttribute("name", "MinOEE");
                        minOEEField.setAttribute("value", self.minOEE);
                        form.appendChild(minOEEField);

                        var maxOEEField = document.createElement("input");
                        maxOEEField.setAttribute("name", "MaxOEE");
                        maxOEEField.setAttribute("value", self.maxOEE);
                        form.appendChild(maxOEEField);
    ...
    return VistaInformeSeguimientoDiario;
});
