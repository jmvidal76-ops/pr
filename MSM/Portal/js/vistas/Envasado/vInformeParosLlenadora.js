define(['underscore', 'backbone', 'jquery', 'text!../../../Envasado/html/InformeParosLlenadora.html', 'compartido/notificaciones'], function (_, Backbone, $, PlantillaInformeParosLlenadora,Not) {
    var VistaInformeParosLlenadora = Backbone.View.extend({
        tagName: 'div',
        template: _.template(PlantillaInformeParosLlenadora),
        ...
        render: function () {
            ...
            $(this.el).kendoWindow(
            {
                title: window.app.idioma.t('PAROS_LLEN_MAQ'),
                width: "450",
                height: "300px",
                modal: true,
                resizable: false,
            ...
            if (self.linea == "" || self.turnoInicio == "Seleccione" || self.turnoFin == "Seleccione" || self.dpinicio == null || self.dpfin == null) {
                ...
                $.ajax({
                    ...
                    $.ajax({
                        ...
                        form.setAttribute("action", "/Informes/INF-ENV-PROD_ANA-2.aspx");
    ...
    return VistaInformeParosLlenadora;
});