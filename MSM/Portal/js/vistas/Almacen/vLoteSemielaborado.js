define(['underscore', 'backbone', 'jquery', 'text!../../../Almacen/html/LoteSemielaborado.html', 'compartido/notificaciones', 'compartido/utils',
    ...
    function (_, Backbone, $, plantillaGestionMateriales, Not, Utils, VistaDlgConfirm, JSZip,
        ...
        var gridMateriales = Backbone.View.extend({
            ...
            initialize: function () {
                ...
                self.PropiedadesEditables = TienePermiso(256);
                self.render();
            ...
            render: function () {
                ...
                self.dsStock = new kendo.data.DataSource({
                    ...
                    transport: {
                        read: {
                            url: "../api/ObtenerStockLoteSemielaborado",
                            dataType: "json",
                            contentType: "application/json; charset=utf-8",
                            type: "GET"
                        },
                        create: {
                            url: "../api/AgregarLoteSemielaborado",
                            dataType: "json",
                            contentType: "application/json; charset=utf-8",
                            type: "POST"
                        },
                        update: {
                            url: "../api/ActualizarLoteSemielaborado",
                            dataType: "json",
                            contentType: "application/json; charset=utf-8",
                            type: "PUT"
                        },
                    ...
                    schema: {
                        ...
                        model: {
                            ...
                            fields: {
                                ...
                                'DescripcionUbicacion': { type: "string", editable: false },
                                'IdMaterial': {
                                    type: "string",
                                    validation: {
                                        required: true,
                                ...
                                'UbicacionConDescriptivo': { type: "string" },
                       ...
                       },                        
                       {
                        ...
                        },
                        {
                            template: "<button type='button' id='btnNotasLote' class='k-button k-button-icontext' " +
                                "data-funcion='FAB_PROD_EXE_10_VisualizacionLoteSemielaborado FAB_PROD_EXE_10_GestionLoteSemielaborado' " +
                ...
                var _operaciones = $("#btnOperations").kendoDropDownList({
                    ...
                    select: function (e) {
                        if (e.item) {
                            ...
                            switch (dataItem.id) {
                                case self.constantes.CREAR_LOTE_2:
                                    grid.addRow();
                                    break;
            ...
            eliminarLotes: function (_lotesSeleccionados) {
                ...
                _lotesSeleccionados.each(function () {
                    ...
                    $.ajax({
                        type: "DELETE",
                        url: "../api/EliminarLoteSemielaborado/" + _item.IdLoteSemielaborado,
                        dataType: 'json',
                        async: false
                ...
                $('<input data-text-field="DescripcionCompleta"  class="width-80" id="materialDrop"  data-value-field="IdMaterial" name="sl' + options.field + '" data-bind="value:' + options.field + '"/>')
                    ...
                    .kendoDropDownList({
                        ...
                        open: function (e) {
                            ...
                            this.setDataSource(this.dataSource.data().filter(item => item.Tipo == self.tiposMateriales.Default || item.Tipo == self.tiposMateriales.Semielaborados || item.Tipo == self.tiposMateriales.Subproductos));
                        },
                        dataSource: {
            ...
            UoMDropdDownEditor: function (container, options) {
                ...
                $('<input data-text-field="SourceUoMID" class="width-80" id="uomDrop"  data-value-field="PK" name="sl' + options.field + '" data-bind="value:' + options.field + '"/>')
                    .appendTo(container)
                    .kendoDropDownList({
                        filter: "contains",
                        dataBound: function (e) {
