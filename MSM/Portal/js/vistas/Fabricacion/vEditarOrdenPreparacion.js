                ...
                self.grid = this.$("#gridMateriasPrimas").kendoGrid({
                    ...
                    columns: [
                        ...
                        },
                        {
                            ...
                            command:
                            [{
                                template: "<a id='btnEditarMateriaPrima' class='k-button k-edit' style='min-width:16px;'><span class='k-icon k-edit'></span></a>"

                            },
                            {
                                template: "<a id='btnBorrarMateriaPrima' class='k-button k-grid-delete' style='min-width:16px;'><span class='k-icon k-delete'></span></a>"
