...
'vistas/Fabricacion/vEditarOrdenPreparacion'],
        ...
        var vista = Backbone.View.extend({
            ...
            render: function () {
                ...
                for (i = 0; i < window.app.sesion.attributes.funciones.length; i++) {
                    if (window.app.sesion.attributes.funciones[i].id === 162)
                        self.permisoVisualizacion = true;
                    if (window.app.sesion.attributes.funciones[i].id === 163)
                ...
                self.dsOrdenesPreparacion = new kendo.data.DataSource({
                    transport: {
                        read: {
                            url: "../api/GetOrdenesPreparacion/0",//0 - Activas / 1 - Finalizadas
                            dataType: "json"
                        }
                    },
                    schema: {
                    ...
                    columns: [
                         {
                             ...
                             attributes: { style: 'white-space: nowrap ', "align": "center", "class": 'addTooltip' }
                         },
                         {
                             field: "Descripcion",
                         ...
                         },
                        {
                        ...
                        },
                         {
                             ...
                             template: "# if(IdEstado != 3){#<div><select class='selectEstado' id='estado#=IdOrden#' style='width:120px;float:left;'></select><input type='image' id='btnEst#=IdOrden#' class='btnCambiaEstado' style='float:left;margin-left:5px;'; src='img/play-24.png' /></button></div>#} else {''}#"
                         },
                          {
                              field: "IdOrden",
                        ...
                        },
                        {
                         ...
                         
                         {
                             ...
                             template: "# if(IdEstado != 3){#<div align='center' title='" + window.app.idioma.t("EDITAR") + "'><a id='btnEditar' class='k-button k-edit' style='min-width:16px;'><span class='k-icon k-edit'></span></a></div>#} else {''}#"
                ...
                $("#gridOrdenesPreparacion").kendoTooltip({
                    filter: ".addTooltip",
                    content: function (e) {
            ...
            validarCambio: function (e) {
                ...
                if (typeof $("#btnAceptarVolumen").data("kendoButton") === "undefined" || typeof $("#btnCancelarVolumen").data("kendoButton") === "undefined") {
                    self.renderButtons(self);
                }
                if (self.cambio.idEstado != "") {
