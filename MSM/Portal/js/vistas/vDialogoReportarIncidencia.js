define(['underscore', 'backbone', 'jquery', 'text!../../html/dialogoReportarIncidencia.html', 'compartido/notificaciones'],
    function (_, Backbone, $, plantillaDlgIncidencia, Not) {
            ...
            enviar: function () {
                ...
                if (incidencia.descripcion) {
                    $.ajax({
                        ...
                        success: function (e) {
                            Not.crearNotificacion('success', window.app.idioma.t('AVISO'), window.app.idioma.t('LA_INCIDENCIA_SE'), 4000);
