define(['underscore', 'backbone', 'jquery', 'text!../../../Mermas/html/MermasDatosCoccion.html', 'vistas/vDialogoConfirm',
    'compartido/notificaciones', 'jszip', '../../../../Portal/js/constantes', 'compartido/util'],
    function (_, Backbone, $, PlantillaMermasDatosCoccion, VistaDlgConfirm, Not, JSZip, enums, util) {
        var VistaDatosCoccion = Backbone.View.extend({
            ...
            fechaCargada: null,
            template: _.template(PlantillaMermasDatosCoccion),
            initialize: function () {
                var self = this;
                window.JSZip = JSZip;
            ...
            render: function () {
                ...
                self.grid = this.$("#gridDatosMermas").kendoExtGrid({
                    ...
                    excel: util.ui.default.gridExcelDate('DATOS_COCCION'),
            ...
            confirmarEditarMovimientos: function () {
                ...
                $win.find("#btnAceptarEdicion").off('click').on("click", function () {
                    ...
                    $.ajax({
                        url: "../api/CalculoMermas/ActualizarDatosCalculoMermas?zona=Coccion",
                        type: "PUT",
