    ...
    function (_, Backbone, $, VistaDlgConfirm, plantillaJustificacionMultiplesParos, Not, KeyboardSettings) {
        var VistaJustificacionParo = Backbone.View.extend({
            ...
            render: function () {
                ...
                $(this.el).kendoWindow(
                {
                    title: window.app.idioma.t('JUSTIFICAR_PERDIDA'),
                    width: "1200px",
                    maxHeight: "744px",
                    height: 485 + self.Perdidas.length * self.heightP + "px",
                    modal: true,
                    resizable: false,
                    draggable: false,
                    actions: []
            ...
            aceptar: function () {
                ...
                self.vistaConfirmacion = new VistaDlgConfirm({
                    ...
                    msg: window.app.idioma.t('MSG_JUSTIFICAR_MULTIPLES_PERDIDAS'),
            ...
            confirmarJustificacion: function () {
                ...
                jQuery.each(self.Perdidas, function (index, value) {
                    ...
                    $.ajax({
                        ...
                        if (index == (self.Perdidas.length - 1)) {
                            self.dialog.close();
