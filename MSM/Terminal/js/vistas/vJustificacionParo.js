    ...
    function (_, Backbone, $, plantillaJustificacionParo, VistaDlgConfirm, Not, KeyboardSettings) {
        var VistaJustificacionParo = Backbone.View.extend({
            ...
            render: function () {
                ...
                $(this.el).kendoWindow({
                    title: window.app.idioma.t('EDITAR_PARO_MAYOR'),
                    width: "1200px",
                    height: "485px",
                    modal: true,
                    resizable: false,
            ...
            aceptar: function () {
                ...
                $.ajax({
                    ...
                    if (e.status == '403' && e.responseJSON == 'NotAuthorized') {
                        ...
                        Not.crearNotificacion('error', window.app.idioma.t('ERROR'), window.app.idioma.t('ERROR_JUSTIFICANDO_PAROS') + ': ' + e.Message, 4000);
                    }
                });
            },
            cancelar: function () {
