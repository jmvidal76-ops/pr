...
/****** Object:  View [dbo].[IndicesRecomendadosPorUso]    Script Date: 21/04/2021 10:22:52 ******/
SET ANSI_NULLS ON
GO
...
CREATE VIEW [dbo].[IndicesRecomendadosPorUso]
AS
...
--AND OBJECT_NAME(id.[object_id], db.[database_id]) = 'XML_Final'
